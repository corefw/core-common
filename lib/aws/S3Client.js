...
class S3Client extends ParentClass {
	 ...
	 */
	XX_deployFile( localRelPath, remoteRelPath ) {
	 ...
	 * @returns {Promise<AWS.Request>} Handle to the operation request.
	 */
	XX__deployOneFile( localRelPath, remoteRelPath ) {
	 ...
	 * @returns {Promise<AWS.Request>} Handle to the operation request.
	 */
	XX_putObjectAsJson( remoteRelPath, obj ) {
	 ...
	 * @returns {Promise<AWS.Request>} Handle to the operation request.
	 */
	XX_putObjectAsYaml( remoteRelPath, obj ) {
	 ...
	 */
	XX_resolveRemoteAbs( relRemotePath ) {
	 ...
	 */
	XX_resolveRemoteAbsFull( relRemotePath ) {
	 ...
	 */
	XX_deleteRemotePath( relRemotePath ) {
	 ...
	 */
	XX__deleteRemoteAbsPath( remoteAbsPath ) {
	 ...
	 * @returns {Promise<AWS.Request>} Handle to the operation request.
	 */
	XX__putObject( remoteRelPath, body ) {
	 ...
	 */
	XX__getObjectsAtPath( remoteAbsPath ) {
	 ...
	 */
	XX__getSubdirectories( bucket, remoteAbsPath ) {
