...
class Core {
	...
	static get assetManager() {
		return this._getRootSingleton( "assetManager", "./asset/Manager" );
	}
	 ...
	 */
	static get mixer() {
		return this._getRootSingleton( "mixer", "./asset/Mixer" );
	}
	 ...
	 */
	static get igniter() {
		return this._getRootSingleton( "igniter", "./app/Igniter" );
	}
	...
	static get classInspector() {
		return this._getRootSingleton( "classInspector", "./asset/ClassInspector" );
	}
	...
	static get debugInspector() {
		return this._getRootSingleton( "debugInspector", "./debug/Inspector" );
	}
	...
	static get validator() {
		return this._getRootSingleton( "validator", "./type/Validator", {
	...
	static get errorManager() {
		return this._getRootSingleton( "errorManager", "./error/Manager" );
	}
	...
	static get moduleLoader() {
		return this._getRootSingleton( "moduleLoader", "./asset/module/Loader" );
	}
	 ...
	 * @param {arguments} args - The Arguments Object that was generated in the forwarding/callee function.
