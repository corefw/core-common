...
class ClassLoader extends Core.cls( "Core.abstract.Component" ) {
	...
	instantiateClass( fullClassName, cfg = null ) {
		...
		if( !_.isString( fullClassName ) ) {
			...
			if( fullClassName.prototype !== null && fullClassName.prototype !== undefined &&
				fullClassName.prototype.$amClassName !== null && fullClassName.prototype.$amClassName !== undefined ) {

				cfg.$corefw.fullClassName = fullClassName.prototype.$amClassName;

			} else if( fullClassName.prototype !== null && fullClassName.prototype !== undefined &&
				fullClassName.prototype.constructor !== null &&	fullClassName.prototype.constructor !== undefined &&
