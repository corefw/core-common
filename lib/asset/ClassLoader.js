...
class ClassLoader extends Core.cls( "Core.abstract.Component" ) {
	...
	instantiateClass( fullClassName, cfg = null ) {
		...
		if ( !_.isString( fullClassName ) ) {

			if (
				fullClassName.prototype !== null &&
				fullClassName.prototype !== undefined &&
				fullClassName.prototype.$amClassName !== null &&
				fullClassName.prototype.$amClassName !== undefined
			) {

				cfg.$corefw.fullClassName = fullClassName.prototype.$amClassName;

			} else if (
				fullClassName.prototype !== null &&
				fullClassName.prototype !== undefined &&
				fullClassName.prototype.constructor !== null &&
				fullClassName.prototype.constructor !== undefined &&
				fullClassName.prototype.constructor.name !== null &&
				fullClassName.prototype.constructor.name !== undefined
			) {

				cfg.$corefw.fullClassName = fullClassName.prototype.constructor.name;

			} else {

				cfg.$corefw.fullClassName = "UnknownClass";
	...
	_injectIocValues( ClassDefinition, cfg ) {
		...
		if (
			ClassDefinition.getClassDependencies === undefined ||
			typeof ClassDefinition.getClassDependencies !== "function"
		) {
		...
		// If our config is not missing any dependency values for
