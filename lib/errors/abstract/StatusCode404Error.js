/**
 * @file Defines the StatusCode404Error class.
 */
...
/**
 * The root error for status code 404 errors.
 *
 * @abstract
 * @memberOf Errors.Abstract
 * @extends Errors.Abstract.BaseError
 */
class StatusCode404Error extends BaseError {
...
module.exports = StatusCode404Error;
