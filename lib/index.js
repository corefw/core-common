 ...
 * The returned object will include a number of VERY fundamental utility objects that can be used to instantiate various
...
Core.assetManager.registerDependencies( {
	...
	"verror": () => {
		...
		return require( "verror" );

	},
	"indefinite": () => {

		return require( "indefinite" );
