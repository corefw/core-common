...
assetManager.registerDependencies( {
	...
	// todo: remove these..
	//"ajv"            : () => { return require( "ajv" ); 				},
	//"jsonwebtoken"   : () => { return require( "jsonwebtoken" ); 		},
	//"mysql2"         : () => { return require( "mysql2" ); 			},
	//"redis"          : () => { return require( "redis" ); 			},
	//"sequelize"      : () => { return require( "sequelize" ); 		},
