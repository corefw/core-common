/**
 * @file
 * Defines the Core.type.check.simple.IsRegExp class.
 *
...
/**
 * A simple check that determines if a target variable is a 'RegExp Object'.
 *
 * Note: This check is a thin wrapper for the Lodash function `isRegExp` and its `evaluateTarget` method will
 * behave identically to that function.
 *
 * @memberOf Core.type.check.simple
 * @extends Core.type.check.simple.BaseSimpleCheck
 */
class IsRegExp extends Core.cls( "Core.type.check.simple.BaseSimpleCheck" ) {
	...
	static get description() {
		return "Checks if a value is classified as a RegExp object.";
	}
	...
	/**
	 * Checks if a `value` is classified as a RegExp object.
	 *
	 * @static
	 * @public
	 * @param {*} value - The value to check.
	 * @returns {boolean} Returns TRUE if `value` is a regexp object; otherwise it returns FALSE.
	 */
