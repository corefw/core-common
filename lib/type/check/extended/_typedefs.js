/**
 * @file
 * Defines the `Core.type.check.extended` namespace.
 *
...
/**
 * Contains classes used to identify, validate, and describe the 'type' that a variable is using more complex comparison
 * functions that require additional arguments.
 *
 * @namespace extended
