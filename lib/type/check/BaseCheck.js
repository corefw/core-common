...
class BaseCheck extends Core.cls( "Core.abstract.Component" ) {
	 ...
	 *
	 * @public
	 * @throw Error if a non-conforming variable/value is passed as `value`.
	...
	static describeTarget( value, opts = null ) {
		...
		if( this.evaluateTarget( value ) === false ) {
			throw new Error( "Invalid `value` provided to `Core.type.check.BaseCheck::describeTarget()`; check classes can only be used to describe conforming values!" );
		}
