/**
 * @file
 * Defines the Core.ns.provider.Handler Object.
 *
...
// We need to be able to spawn new namespace
// providers, for child namespaces.
const Provider = require( "../Provider" );


isItAFunction( module.exports, "Handler.js -> Provider" );
...
/**
 * This object is a Proxy Handler that, when applied, will cause a class to behave
 * as though it is a namespace containing a nested tree of other namespaces and
 * entities within them.
 *
 * @memberOf Core.ns.provider
 */
const Handler = {

	getX: function( obj, prop ) {
