/**
 * @file
 * Defines tests for the Core.type.check.simple.IsNull class.
 *
...
describe( "Core.type.check.simple.IsNull", function () {
	...
	before( function () {
		...
		check = Core.cls( "Core.type.check.simple.IsNull" );
	...
	describe( "<- Core.type.check.Collection#getFirstDescriptiveMatch()", function() {
		...
		it( "should return this check ('isNull') as the first, descriptive, match for NULL values", function () {
