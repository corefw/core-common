/**
 * @file
 * Defines tests for the Core.type.check.simple.IsUndefined class.
 *
...
describe( "Core.type.check.simple.IsUndefined", function () {
	...
	before( function () {
		...
		check = Core.cls( "Core.type.check.simple.IsUndefined" );
	...
	describe( "<- Core.type.check.Collection#getFirstDescriptiveMatch()", function() {
		...
		it( "should return this check ('isUndefined') as the first, descriptive, match for UNDEFINED values", function () {
