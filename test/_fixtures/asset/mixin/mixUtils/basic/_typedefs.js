/**
 * @file
 * Defines the `Test.fixture.asset.mixin.mixUtils.basic` namespaces.
 *
...
/**
 * Contains mock classes used to test basic functionality of the `Core.asset.mixin.MixUtilsMixin` framework mixin.
 * @namespace basic
 * @memberof Test.fixture.asset.mixin.mixUtils
 */
