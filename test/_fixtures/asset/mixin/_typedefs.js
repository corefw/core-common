/**
 * @file
 * Defines the `Test.fixtures.asset.mixin` namespace.
 *
...
/**
 * Contains mock classes used to test framework mixins in the `Core.asset.mixin` namespace.
 * @namespace mixin
 * @memberof Test.fixture.asset
 */
