/**
 * @file
 * Defines the `Test.fixtures.asset.classLoader.basic` namespaces.
 *
...
/**
 * Contains mock classes used to test the basic functionality of the `Core.asset.ClassLoader` framework class.
 * @namespace basic
 * @memberof Test.fixture.asset.classLoader
 */
