/**
 * @file
 * Defines the `Test.fixtures.asset.mixer.basic` namespaces.
 *
...
/**
 * Contains mock classes used to test the basic functionality of the `Core.asset.Mixer` framework class.
 * @namespace basic
