/**
 * @file
 * Defines the `Test.fixtures.asset.mixer.onMixin` namespaces.
 *
...
/**
 * Contains mock classes used to test the `Core.asset.Mixer`'s automatic execution of any $mixin() methods
 * provided by mixins.
 *
 * @namespace onMixin
