/**
 * @file
 * Defines the `Test.fixture.util.mixin` namespaces.
 *
...
/**
 * Contains mock classes used to test framework classes in the `Core.util.mixin` namespace.
 * @namespace mixin
 * @memberof Test.fixture.util
 */
