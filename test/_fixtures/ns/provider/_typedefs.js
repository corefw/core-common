/**
 * @file
 * Defines the `Test.fixture.ns.provider` namespace.
 *
...
/**
 * Contains mock classes used to test the namespace provider logic that the `Core.ns.ProxyApplicator` applies
 * to classes.
 * @namespace provider
 * @memberof Test.fixture.ns
 */
