/**
 * @file
 * Defines the `Test.fixture.abstract.component.mixin` namespace.
 *
...
/**
 * Contains mock classes used to test the mixin logic & functionality of the `Core.abstract.Component` framework class.
 *
 * @namespace mixin
