/**
 * @file
 * Defines the `Test.fixture.abstract.component.construct` namespaces.
 *
...
/**
 * Contains mock classes used to test the $construct logic & functionality of the `Core.abstract.Component` framework class.
 *
 * @namespace construct
