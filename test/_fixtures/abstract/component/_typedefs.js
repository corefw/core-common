/**
 * @file
 * Defines the `Test.fixture.abstract.component` namespace.
 *
...
/**
 * Contains mock classes used to test the `Core.abstract.Component` framework class.
 * @namespace component
 * @memberof Test.fixture.abstract
 */
