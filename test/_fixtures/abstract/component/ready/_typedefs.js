/**
 * @file
 * Defines the `Test.fixture.abstract.component.ready` namespaces.
 *
...
/**
 * Contains mock classes used to test the $ready logic & functionality of the `Core.abstract.Component` framework class.
 *
 * @namespace ready
