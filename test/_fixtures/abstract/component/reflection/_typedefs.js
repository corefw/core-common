/**
 * @file
 * Defines the `Test.fixture.abstract.component.reflection` namespace.
 *
...
/**
 * Contains mock classes used to test the reflection logic & functionality of the `Core.abstract.Component` framework class.
 *
 * @namespace reflection
 * @memberof Test.fixture.abstract.component
 */
