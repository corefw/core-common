/**
 * @file
 * Defines the `Test.fixture.debug.inspector` namespace.
 *
...
/**
 * Contains mock classes used to test the `Core.debug.Inspector` framework class.
 * @namespace inspector
 * @memberof Test.fixture.debug
 */
