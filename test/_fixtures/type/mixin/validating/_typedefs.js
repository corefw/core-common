/**
 * @file
 * Defines the `Test.fixture.type.mixin.validating` namespaces.
 *
...
/**
 * Contains mock classes and mixins used to test the `Core.type.mixin.Validating` framework mixin.
 * @namespace validating
 * @memberof Test.fixture.type.mixin
 */
