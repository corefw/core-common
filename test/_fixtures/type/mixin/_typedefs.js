/**
 * @file
 * Defines the `Test.fixture.type.mixin` namespaces.
 *
...
/**
 * Contains mock classes used to test framework mixins in the `Core.type.mixin` namespace.
 * @namespace mixin
 * @memberof Test.fixture.type
 */
